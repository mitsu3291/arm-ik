...
from ik_constraints import IKCon
...
if __name__ == "__main__":
    ...
    ik_solver = IKCon(l1=l1, l2=l2, l3=l3, q1=q1, q2=q2, q3=q3, x_ref=1, y_ref=0,
                     eps=1e-4, iter_max=1000, alpha=1.0, damp0=1e-3, omega_max=math.pi/2, dt=1e-1)
    ...
    for i in range(100):
        ...
        if i==0:
            q1, q2, q3 = ik_solver.solve(is_first=True)
        else:
            q1, q2, q3 = ik_solver.solve(is_first=False)
